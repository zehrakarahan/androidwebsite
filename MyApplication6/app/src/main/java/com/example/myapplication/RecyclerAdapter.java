...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ...
        holder.fiyatTextView.setText(String.valueOf(currentTeacher.getFiyat()));
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener ,
        ...
        public TextView nameTextView,descriptionTextView,dateTextView,fiyatTextView;
        ...
        public RecyclerViewHolder(View itemView)
        {
            ...
            fiyatTextView=(TextView)itemView.findViewById(R.id.fiyatTextView);
            teacherImageView=(ImageView) itemView.findViewById(R.id.teacherImageView);
